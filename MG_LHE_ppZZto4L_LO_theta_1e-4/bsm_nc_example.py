...
The script uses the `bsm_nc_module` for amplitude calculations.
"""
...
def main():
    ...
    p1 = np.array([215.232, 0.0, 0.0, -215.232])  # High-energy quark
    k1 = np.array([184.748, -12.054, 36.0525, -155.531])    # First Z-boson
    k2 = np.array([98.1731, 12.054, -36.0525, 7.98776])  # Second Z-boson
